...
C         cray:
C
C         cf77 ua2g.f -o ua2g
C         ua2g
C         stnmap -i ua.ctl
C         grads -lc "open ua.ctl"
C         
C         Files:
C         
C         ua.txt    ASCII source data: s.txt
C         
C         cray:
C
C         ua.obs    GrADS binary format
C         ua.smp    station map file (16 bytes on 32-bit machines
C         ua.ctl    GrADS data descriptor file
C         
...
C
      card='assign -s unblocked -a ua.cray.obs fort.12'
      call assign(card)
