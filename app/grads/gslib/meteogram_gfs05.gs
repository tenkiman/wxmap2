...
#
if(usecola=1)
  pbase=pdir'/meteogram.gfs05.'name'.'date'.tau.0.'_nhr'.'_dhr'.cola'
else
  pbase=pdir'/meteogram.gfs05.'name'.'date'.tau.0.'_nhr'.'_dhr'.ncep'
endif
...
label = 'GFS05 'date' 0-180 h Meteogram for ('
