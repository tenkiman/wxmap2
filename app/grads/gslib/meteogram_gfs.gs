...
* http://cola8.iges.org:9191/dods/gfs for a complete 
...
if(usecola=1)
  _baseurl = 'http://cola8.iges.org:9191/dods/gfs/'
  _dataset = 'gfs'date
  'sdfopen '_baseurl%_dataset
else
  dpath='/tmp/nomads.gfs.ctl'
  fc=ofile(dpath,'xdf')
endif
...
print 'tttttttttttt '_tincr' '_tsize

if(_tincr = '360mn') ; _dhr=6 ; _tbucket=6 ; endif
if(_tincr = '180mn') ; _dhr=3 ; _tbucket=6 ; endif
...
#
if(usecola=1)
  pbase=pdir'/meteogram.gfs.'name'.'date'.tau.0.'_nhr'.'_dhr'.cola'
else
  pbase=pdir'/meteogram.gfs.'name'.'date'.tau.0.'_nhr'.'_dhr'.ncep'
endif
...
# 
# clear out title area and bottom
#

'set line 0'
'draw recf 0 10.52 8.5 11.0'

'set line 0'
'draw recf 0 0 8.5 0.15'

'set string 1 r 1 0'
'set strsiz 0.12'

label = 'GFS 'date' 0-180 h Meteogram for ('
