...
cmdFD="w2-fld-cmc-gdps-wget-mirror.py"
...
for dtg in dtgs:
    ...
    if(not(bypassChkRunning)):
        rc=w2.ChkIfRunningNWP(dtg,pyfile,model,verb=verb)
    else:
        rc=-1
    ...
    if(bypassChkRunning): overoptFD='-O -R'
