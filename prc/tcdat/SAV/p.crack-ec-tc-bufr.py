        ...
        if len(latitudeAnalysis) == len(memberNumber) and len(latitudeMaxWind0) == len(memberNumber):
            ...
            for k in range(len(memberNumber)):
                try:
                    ...
                    data[k][0] = [CODES_MISSING_DOUBLE, CODES_MISSING_DOUBLE, CODES_MISSING_DOUBLE, CODES_MISSING_DOUBLE, CODES_MISSING_DOUBLE]
        ...
        for i in range(1, numberOfPeriods):
            ...
            for k in range(len(memberNumber)):
                try:
                    ...
                    data[k][i] = [CODES_MISSING_DOUBLE, CODES_MISSING_DOUBLE, CODES_MISSING_DOUBLE, CODES_MISSING_DOUBLE, CODES_MISSING_DOUBLE]
                    print 'problem with k=',k 
