...
if(_printBmap = 1)
  if(_verb) ; print 'BBBB: '_bkgpath ; endif
...
#print 'TTTTTTTTTTTTTTTTTTTTTTTTTTTTT tmppngpath in pltsp: 'tmppngpath' '_printBmap  
...
if(nf = 0)
   print 'WWW--ad2.gs no members for tau: 'tau' dtg: '_bdtg' model: '_model
   return(0)
endif
