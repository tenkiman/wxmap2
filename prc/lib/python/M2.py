...
class ModelS(MFbase):
    ...
    def __init__(self,model='mmm',center='nanimo',gribver=2,bdir2=None):
        ...
        self.myname="Dr. Mike Fiorino (mike@wxmap2.com) WxMAP2, Ave Maria, FL"
...
class Jgsm(ModelS):
    ...
    def setDbase(self,dtg,dtype='w2flds',warn=0):
        ...
        if(dtype == 'w2flds'):
            ...
            self.dmodelType=dtype
            self.bddir="%s/%s"%(self.w2fldsSrcDir,cyear)
            self.dbasedir="%s/%s"%(self.bddir,dtg)
...
endvars'''%(optiondtype,latlongrid)
    ...
    def GetDataStatus(self,dtg,checkNF=0,mintauNF=5):
        ...
        if(self.tautype == 'alltau' and siz > 0):
            latestCompleteTau=datataus[-1]
    ...
    def getDataTaus(self,dtg):
        taus=range(0,self.etau+1,self.dtau)
        return(taus)
    ...
    def setgmask(self,dtg):
        self.gmask="%s.w2fld.%s*"%(self.model,dtg)
...
class Goes(Gfs2):
    ...
    def setxwgrib(self,dtg):
        ...
        if(self.doLn):
            ...
            self.dmask="%s.t%sz.goessimpgrb2.0p25.f???"%(self.dmodel,hh)
    ...
    def setDbase(self,dtg,dtype=None):
        ...
        self.dbase="%s/%s.t%sz.goessimpgrb2.0p25deg.grib2"%(self.dbasedir,self.lmodel,hh)
...
class Cgd2(Model2):
    ...
    # -- 2021092812 -- new higher res...now 0.15...but keep 0.25 regrid
    #

    def __init__(self,model='cgd2',center='cmc',bdir2=None,gribver=2):
...
def setModel2(model,bdir2=None):
    ...
    elif(model == 'era5x'): return(Era5x(bdir2=bdir2))
    ...
    elif(model == 'cgd2'): return(Cgd2(bdir2=bdir2))
