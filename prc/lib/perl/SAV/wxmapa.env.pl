...
# 20090503 -- switch season here and in w2env.py
$WXMAP_CUR_YEAR='2009';
$tcseason='NHS';
...
$WXMAP{'WXMAP_WEB_DIR'}="$WXMAP2_BDIR/weba";  # 970707 change to the op dirs
...
if($EcmModel eq 'ecmn') {
  $WXMAP{'WXMAP_MODELS'}="gfs:fim:ecmn:ngp:ukm";
} else {
  $WXMAP{'WXMAP_MODELS'}="gfs:fim:ecm:ngp:ukm";
}

$WXMAP{'WXMAP_MODELS_RES'}="05:05:10:10:07";
$WXMAP{'WXMAP_MODELS_CENTER'}="ncep:esrl:ecmwf:fnmoc:ukmo";
$WXMAP{'WXMAP_MODELS_GRF_EXT'}="05:05:10:10:07";
$WXMAP{'WXMAP_MODELS_HTTP_GDIR'}="plt_ncep_gfs:plt_esrl_fim:plt_ecmwf_ecm:plt_fnmoc_ngp:plt_ukmo_ukm";
$WXMAP{'WXMAP_MODELS_DESC'}="NCEP GFS:ESRL FIM:ECMWF IFS:FNMOC NGP:UKMO UM";
$WXMAP{'WXMAP_MODELS_BKG'}="bkgred.gif:bkgyello.gif:bkgyello.gif:bkgblue.gif:bkgyello.gif";
$WXMAP{'WXMAP_MODELS_RUN00'}="1:1:1:1:1";
$WXMAP{'WXMAP_MODELS_RUN06'}="1:0:0:0:1";
$WXMAP{'WXMAP_MODELS_RUN12'}="1:1:1:1:1";
$WXMAP{'WXMAP_MODELS_RUN18'}="1:0:0:0:1";
$WXMAP{'WXMAP_MODELS_NTAU'}="168:168:168:144:144";
$WXMAP{'WXMAP_MODELS_DATA_NTAU'}="180:168:180:144:144";
$WXMAP{'WXMAP_MODELS_TAUINC'}="12:12:12:12:12";
$WXMAP{'WXMAP_MODELS_TAUINC_RUN'}="6:12:12:12:6";
$WXMAP{'WXMAP_MODELS_PRACCUM'}="12:12:12:12:12";

$WXMAP{'WXMAP_MODELS_ADD_MAPS'}="0:0:0:0:0";
$WXMAP{'WXMAP_MODELS_COLOR'}="red:yellow:green:blue:yellow";
$WXMAP{'WXMAP_MODELS_UCASE'}="GFS:FIM:ECM:NGP:UKM";
$WXMAP{'WXMAP_MODELS_GRID_RES'}="05:05:10:10:07";



$WXMAP{'WXMAP_MODELS_CURRENT_GRFDIR'}="$WXMAP2_BDIR/weba/plt_ncep_gfs:$WXMAP2_BDIR/weba/plt_esrl_fim:$WXMAP2_BDIR/weba/plt_ecmwf_ecm:$WXMAP2_BDIR/weba/plt_fnmoc_ngp:$WXMAP2_BDIR/weba/plt_ukmo_ukm";

$WXMAP{'WXMAP_MODELS_ARCHIVE_GRFDIR'}=$WXMAP{'WXMAP_MODELS_CURRENT_GRFDIR'};

$WXMAP{'WXMAP_MODELS_ARCHIVE_MOVIEDIR'}=\
"$WXMAP2_BDIR/weba/plt_ncep_gfs/movie:\
$WXMAP2_BDIR/weba/plt_esrl_fim/movie";

$WXMAP{'WXMAP_MODELS_GDIR'}="$WXMAP2_BDIR/weba/plt_ncep_gfs:$WXMAP2_BDIR/weba/plt_esrl_fim:$WXMAP2_BDIR/weba/plt_ecmwf_ecm:$WXMAP2_BDIR/weba/plt_fnmoc_ngp:$WXMAP2_BDIR/weba/plt_ukmo_ukm";
...
$WXMAP{'WXMAP_TC_STRUCT_DAT_DIR'}="/wxmap2/dat2/tc/tcanal";
...
$plot_control{'ngp','asia','plots'} = $PlotsMidLat;
...
$plot_control{'ngp','wconus','plots'} = $PlotsMidLat;
...
##################################################
  ...
  foreach $model (@amodels) {
    ...
    if($atype ne "") {
	  ...
	  $lsmask="${model}${model_grf_ext{$model}}*${pt}*.png";
