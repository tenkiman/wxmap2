...
c
      ...
      character gfilename*120,ifilename*120
      ...
      integer   pdf_ct_tot,pdf_ct_bin,lugb,lugi,iret
...
c
 ...
 615  format(1x,'#---------------------------------------------------#')
     ...
     &                  ,paramb,vtl_slope,vtu_slope
            ...
            print *,' ><  found storm and therefore we cannot diagnose'
          ...
          print *,' '
          print *,' ><  CPS diagnostics were requested but will NOT be'
...
c     the call to check_closed_contour below.
     ...
     &       ,ifix,jfix,wcore_point_max
          ...
          print *,'!!! In any event, we will not search for a warm core'
          print *,'!!! for this storm and lead time.'
          print *,' '
...
c     -----------------------------------------------------------------
      ...
      do iquad = 1,4
        ...
        print *,'structure iquad= ',iquad,' earth-relative bear= ',bear
...
cstr          print *,' '
cstr          print '(5(a10,f7.2))','  sfclat= ',xsfclat
cstr     &           ,'  sfclon= ',xsfclon
cstr     &           ,'   rdist= ',rdist(idist),' targlat= ',targlat
cstr     &           ,' targlon= ',targlon
cstr          print '(19x,a8,f7.2,35x,a9,f7.2)','sfclon= ',360.-xsfclon
cstr     &                         ,'targlon= ',360.-targlon
...
cstr          print '(2x,a21,f8.2,a14,f8.2)','   intrp wind speed= '
cstr     &                ,er_wind(iquad,idist),'    (in kts)= '
cstr     &                ,er_wind(iquad,idist)*1.9427
...
c     -----------------------------------------------------------------
      ...
      do iquad = 1,4
        ...
        print *,'structure iquad= ',iquad,' storm-relative bear= ',bear
     ...
     &    iend < 1 .or. jend < 1) then
      ...
      if (iend > imax) then
        if (trkrinfo%gridtype == 'global') then
          ...
          print *,'!!! is global, so we are going to leave it as is and'
...
cstr      print '(a6,f7.2,a3,f7.2,a9,f7.2)','xlont= ',xlont,'E  ',360.-xlont
cstr     &                                 ,'W   xlatt=',xlatt
...
c     west of targlon....
      ...
      if (ie > imax) then
        if (trkrinfo%gridtype == 'global') then 
          ...
          print *,' '
          print *,'!!! ERROR: ie > imax in subroutine  bilin_int_uneven'
...
cstr      print *,'  +++ Interpolating winds for cparm= ',cparm
cstr      print '(6x,4(a4,i3))','jn= ',jn,' js= ',js,' iw= ',iw,' ie= ',ie
...
c
      ...
      real      rlat(jmax),cosfac,tanfac,ii,jj
