...
c!!!      this run caused lock up (infinite loop) 
c!!!      added maxccf=10 to only search the first 10 cc for a system -- likely caused by memory allocation local/module ?)
c!!!      ngtrkN.x /dat3/tc/tmtrkN/2011081912/ngpc/ngtrk.nl \
c!!!      /dat3/tc/tmtrkN/2011081912/ngpc/ngtrk.ngtrp.txt /dat3/tc/tmtrkN/2011081912/ngpc/ngpc.2011081912.meta.txt \
c!!!      /dat3/tc/tmtrkN/2011081912/ngpc/ngtrk.out.txt /dat3/tc/tmtrkN/2011081912/ngpc/ngtrk.diag.txt /dat3/tc/tmtrkN/2011081912/ngpc/ngtrk.mfdiag.txt

      integer,  parameter :: maxccf=10
      integer kuvs(4), kint(4)
      real exc, eyc, xc(4), yc(4)
      real ccvdat(2,mxptc)
c . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
c
      write(iunit,*) ' verify, processing ',nccf,' areas for mxptc: ',mxptc
      do n=1, nccf
...
c
      kc = 0
      if(nccf.gt.maxccf) nccf=maxccf
      do n=1, nccf
        exc = ccvdat(1,n)
        eyc = ccvdat(2,n)
        write(iunit,*) 'Verify, checking ',n,' at ',exc,'  ',eyc,mxptc
