...
$dbdir="/tdocommon/wxmap/dat/tc/tcstruct";
$dbdir="~mfiorino/public_html/wxmap2/dat/tc/tcanal";
$dbmask="tc.db.*.txt";
...
<link rel=\"stylesheet\" href=\"/wxmap.css\" type=\"text/css\">
</head>
<body>
<!--
...
$menutable1
<td class=\"med\">
<a href=\"$cgibdir/tcstruct1.cgi?dtg=$dtg&storm=$tstorm&tau=undef&model=undef\">
$dtg
</a>
</td>
";  
...
$menutable1
<td class=\"med\">
<a href=\"$cgibdir/tcstruct1.cgi?dtg=$tdtg&storm=$stm&tau=undef&model=undef\">
$ucstm
</a>
</td>
";  
...
<a href=\"$cgibdir/tcstruct1.cgi?dtg=${tdtg}&storm=${tstorm}&model=$model&tau=${ttau}&ptype=$ptype\">
$umodel
</a>
</td>
";
...
foreach $tau (@taus) {
    $menutable2="$menutable2
<td class=\"big\" align=center>
<a href=\"$cgibdir/tcstruct1.cgi?dtg=${tdtg}&storm=${tstorm}&model=$tmodel&tau=${tau}\">
$tau
</a>
</td>
";
...
$menutable2="$menutable2
<td class=\"big\" align=center>
<a href=\"$cgibdir/tcstruct1.cgi?dtg=${tdtg}&storm=${tstorm}&model=$tmodel&tau=${tau}&ptype=animate\">
animate
</a>
</td>
<td class=\"big\" align=center>
<a href=\"$cgibdir/tcstruct1.cgi?dtg=${tdtg}&storm=${tstorm}&model=$tmodel&tau=${tau}&ptype=profile\">
profile
</a>
</td>
</tr>
...
if($ptype eq 'animate') {
    $pltfile="$bdir/$tdtg/plt/animate.$lctmodel.$tstorm.$tdtg.gif";
    $ttau='000';
} elsif($ptype eq 'profile') {
   $pltfile="$bdir/$tdtg/plt/profile.$lctmodel.$tstorm.$tdtg.png";
    $ttau='000';
} else {
    $pltfile="$bdir/$tdtg/plt/plt.$lctmodel.$tstorm.$ttau.png";
}
