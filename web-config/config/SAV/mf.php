...
} elsif($opt eq 'timeonly') {
  $curdtg="$hour00\:$mn00 UTC" ;
...
if($opt eq 'ph') {
  $curdtg=sprintf("%02d%02d%02d%02d%02d %02d\:%02d",$century,$yr,$mo,$dy,$hr,$phr,$mn);
} elsif($opt eq 'time') {
  $curdtg="$hour00\:$mn00 UTC $dy $mname{$mo00}, ${century}${yr00}" ;
} elsif($opt eq 'timeonly') {
  $curdtg="$hour00\:$mn00 UTC" ;
...
if($opt eq "time") {
  ...
  $curdtg="$hour00\:$mn00 L" ;
} elsif($opt eq "timesec") {
  $curdtg="$hour00\:$mn00\:$sc00 PST $dy $mname{$mo00}, 20$yr" ;
} elsif($opt eq "watchtime") {
  $curdtg="$hr00\:00 Local $dy $mname{$mo00}, 20$yr" ;
} elsif($opt eq "full") {
  $curdtg=sprintf("20%02d%02d%02d%02d",$yr,$mo,$dy,$hr);
} elsif($opt eq "fullhm") {
  $curdtg=sprintf("%02d%02d%02d%02d%02d %02d:%02d",$century,$yr,$mo,$dy,$hr,$fhr,$mn);
} else {
