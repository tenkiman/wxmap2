$(document).ready(function()
{
	...
	inputInfo = "<input id='reload' type='button' class='btn60reload' value='RELOAD'>"
	$('#Row2').append("<div class='divCell'>" + inputInfo + "</div>");
	$('#reload').attr({
		onMouseOver: "className='btn60reloadover'",
		onMouseOut:  "className='btn60reload'"
		});
...
//				updateLatLon();
	...
	//connect WxMain2 butt on
	$('#WxMap').click(function() {
		//window.open('http://ruc.noaa.gov/wxmap2');  // new window
		window.location = "http://maps.wxmap2.com"; // same window
	});
...
// prepare calling object for inventory file
//var xmlhttp = new XMLHttpRequest();
//var invTxt='';
//xmlhttp.onreadystatechange = function() {
//	if(xmlhttp.readyState==4){
//		if (invTxt.length==0) {
//			invTxt = xmlhttp.responseText
//		} else if (invTxt != xmlhttp.responseText) {
//			location.reload(); // reload page if inv file is changed
//		} // else, do nothing
//	}
//}


//setInterval(function()  {xmlhttp.open("GET","prwInv.js",true); 
//			 xmlhttp.send();
//			}
//          ,5000); // check every 5 seconds (5000 milsec)
